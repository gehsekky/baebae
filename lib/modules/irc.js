  ...
  init() {
    this.commands = {
      ...
      topic: function (bot, nick, channel, data) {
        logger.info(`changed topic to ${data} in ${channel} by ${nick}`)
      ...
      op: function (bot, nick, channel, data) {
        ...
        logger.info(`gave ops to ${data} in ${channel} by ${nick}`)
      ...
      deop: function (bot, nick, channel, data) {
        ...
        logger.info(`removed ops from ${data} in ${channel} by ${nick}`)
        bot.client.send('mode', channel, '-' + getModeValue(data, 'o'), data)
      },
      ...
      voice: function (bot, nick, channel, data) {
        ...
        logger.info(`gave voice to ${data} in ${channel} by ${nick}`)
      ...
      devoice: function (bot, nick, channel, data) {
        ...
        logger.info(`removed voice from ${data} in ${channel} by ${nick}`)
        bot.client.send('mode', channel, '-' + getModeValue(data, 'v'), data)
      },
      ...
      kick: function (bot, nick, channel, data) {
        ...
        logger.info(`kicked ${kicked} from ${channel} by ${nick}`)
      ...
      join: function (bot, nick, channel, data) {
        ...
        logger.info(`invited to join channel ${data} from ${channel} by ${nick}`)
        client.join(data)
      },
      ...
      part: function (bot, nick, channel, data) {
        ...
        logger.info(`parting channel ${data} from ${channel} by ${nick}`)
        client.part(data)
      },
      ...
      whois: function ( bot, nick, channel, data ) {
        ...
        bot.client.whois(data, result => {
          ...
          logger.info(`queried whois for ${data} in ${channel} by ${nick}`)
          logger.info('whois data', message)
