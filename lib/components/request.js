 ...
 * @param {Object} options A configuration object with all settings for making the http request
 * @return {Promise} A promise that resolves to the response to the http request
 */
